    ...
    <div className="flex flex-col gap-4 sm:flex-row">
      ...
      <section className="px-6 py-16 md:px-24">
        ...
        <div className="grid grid-cols-1 gap-10 p-8 sm:grid-cols-2 md:grid-cols-3">
          <FeatureCard icon={FaQrcode} title="Instant Menu Access" description="Customers scan a QR code to view your digital menu immediately, no app download needed." href="#" />
          <FeatureCard icon={FaBell} title="Seamless Waiter Call" description="Guests can call a waiter with a single tap, reducing wait times and improving service efficiency." href="#" />
          <FeatureCard icon={FaMobileAlt} title="Contactless Ordering" description="Minimize physical contact with a safe and hygienic ordering process directly from the customer's phone." href="#" />
          <FeatureCard icon={FaCreditCard} title="Integrated Payments" description="Support multiple secure payment methods, allowing customers to pay directly from their table." href="#" />
          <FeatureCard icon={FaMotorcycle} title="Delivery & Takeout" description="Seamlessly integrate with delivery services to manage takeout and delivery orders from one platform." href="#" />
          <FeatureCard icon={FaEdit} title="Real-time Menu Updates" description="Easily update menu items, prices, and availability instantly from your dashboard." href="#" />
          <FeatureCard icon={FaWhatsapp} title="WhatsApp Integration" description="Orders are sent directly to your WhatsApp Business account for simple, direct management." href="#" />
          <FeatureCard icon={FaLanguage} title="Multi-language Menus" description="Offer menus in multiple languages to cater to all guests." href="#" />
          <FeatureCard icon={FaChartBar} title="Performance Analytics" description="Gain valuable insights into customer preferences and sales trends to optimize operations." href="#" />
        </div>
      </section>
