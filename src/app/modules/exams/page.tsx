...
const examFeatures = [
  {
    ...
    benefits: ['Multiple Formats', 'Question Bank', 'Auto-grading']
  },
  {
    title: 'Online Testing',
    description: 'Secure online examination platform with real-time monitoring and anti-cheating measures.',
    icon: ShieldCheckIcon,
    benefits: ['Secure Environment', 'Real-time Monitoring', 'Anti-cheating Tech']
  },
  {
    title: 'Results Analytics',
    description: 'Detailed performance analytics and insights to track student progress and identify areas for improvement.',
    icon: ChartBarIcon,
    benefits: ['Performance Reports', 'Trend Analysis', 'Custom Dashboards']
  },
  {
    title: 'Automated Scheduling',
    description: 'Schedule exams automatically with reminders, notifications, and conflict resolution.',
    icon: ClockIcon,
    benefits: ['Smart Scheduling', 'Auto Reminders', 'Conflict Resolution']
  }
];

const examStats = [
  { number: '25K+', label: 'Exams Conducted' },
  { number: '98%', label: 'Accuracy Rate' },
  { number: '50+', label: 'Question Types' },
  { number: '24/7', label: 'Exam Support' }
];
...
const ExamPage = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="container relative z-10 px-4 mx-auto md:px-6">
          <div className="max-w-4xl pt-20 mx-auto text-center">
            ...
            >
              Comprehensive examination management with secure testing, automated grading, and detailed analytics for academic excellence.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-600">
                Streamlined workflow from exam creation to results analysis
              </p>
            </motion.div>
            ...
            <div className="relative">
              {/* Timeline line */}
              <div className="absolute left-1/2 transform -translate-x-1/2 w-0.5 h-full bg-gradient-to-b from-[#00204f] to-[#02ACC3]"></div>

              <div className="space-y-16">
                {[
                  { step: '01', title: 'Create Exam', description: 'Design comprehensive exams with multiple question types and settings', icon: PencilSquareIcon },
                  { step: '02', title: 'Schedule & Notify', description: 'Set exam dates and automatically notify students and parents', icon: ClockIcon },
                  { step: '03', title: 'Conduct Exam', description: 'Secure online testing with real-time monitoring and anti-cheating measures', icon: ShieldCheckIcon },
                  { step: '04', title: 'Grade & Analyze', description: 'Automated grading with detailed performance analytics and insights', icon: ChartBarIcon }
                ].map((item, index) => (
                  <motion.div
                    key={item.step}
                    ...
                    <div className={`w-full max-w-md ${index % 2 === 0 ? 'pr-8' : 'pl-8'}`}>
                      <div className="p-6 bg-white border border-gray-100 rounded-lg shadow-lg">
                        <div className="flex items-center mb-4">
                          ...
                          <div>
                            <div className="text-sm font-bold text-gray-500">{item.step}</div>
      ...
      {/* Features Section with Hexagonal Cards */}
        ...
        <div className="container px-4 mx-auto md:px-6">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-600">
                Advanced tools designed for secure, efficient, and comprehensive examination management
              </p>
            </motion.div>
        ...
        <div className="container px-4 mx-auto md:px-6">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-600">
                Support for diverse question formats to assess different learning outcomes
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-2 gap-6 md:grid-cols-5">
              {[
                ...
                >
                  <div className="mb-4 text-3xl">{question.icon}</div>
                  <h3 className="text-lg font-bold text-center text-gray-900">{question.type}</h3>
                </motion.div>
              ))}
            </div>
          </div>
      ...
      >
        <div className="container px-4 mx-auto md:px-6">
          ...
          <p className="max-w-2xl mx-auto mb-10 text-lg text-white/90">
            Start creating professional examinations with our comprehensive exam management system.
          </p>
          <Link
            href="/contact-us"
