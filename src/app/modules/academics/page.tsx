...
const features = [
  {
    ...
    description: 'Comprehensive grading system with customizable scales, weighted assignments, and progress tracking.',
    icon: ClipboardDocumentCheckIcon,
    benefits: ['Custom Grading Scales', 'Weighted Assessments', 'Grade Analytics']
  },
  {
    title: 'Curriculum Tracking',
    description: 'Monitor curriculum delivery, learning objectives, and syllabus completion across all subjects.',
    icon: BookOpenIcon,
    benefits: ['Syllabus Management', 'Learning Objectives', 'Progress Mapping']
  },
  {
    title: 'Student Progress Reports',
    description: 'Generate detailed progress reports with insights, trends, and personalized recommendations.',
    icon: ChartBarIcon,
    benefits: ['Performance Analytics', 'Trend Analysis', 'Custom Reports']
  },
  {
    title: 'Class Management',
    description: 'Organize classes, manage student enrollment, and track attendance patterns.',
    icon: UserGroupIcon,
    benefits: ['Class Organization', 'Enrollment Management', 'Attendance Integration']
  }
];
      ...
      >
        ...
        <div className="container relative z-10 px-4 mx-auto md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Comprehensive academic management system designed to streamline curriculum delivery, assessment, and student progress tracking.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-600">
                Powerful tools designed to enhance academic administration and student success
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
              ...
              >
                <h2
                  ...
                  style={{ color: PRIMARY_COLOR }}
                >
                  Why Choose Our Academics Module?
                </h2>
                <p className="mb-6 text-lg text-gray-600">
                  Transform your academic administration with our comprehensive suite of tools designed specifically for educational institutions.
                </p>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="mb-8 text-lg text-gray-600">
                Works perfectly with our other modules including Attendance, Communication, and Reports for a complete educational ecosystem.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                {['Attendance', 'Communication', 'Reports', 'Students'].map((module) => (
                  <span
                    key={module}
        ...
        <div className="container px-4 mx-auto md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="mb-8 text-lg text-gray-600">
                Join thousands of schools already using our Academics module to streamline operations and improve student outcomes.
              </p>
