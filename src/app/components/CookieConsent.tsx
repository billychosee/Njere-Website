    ...
    <AnimatePresence>
      {showBanner && (
        <motion.div
          ...
          className="fixed bottom-4 left-4 right-4 md:bottom-6 md:left-1/2 md:right-auto md:-translate-x-1/2 z-50 w-[calc(100%-2rem)] md:w-[95%] max-w-4xl p-1 rounded-3xl shadow-2xl"
          style={{
          ...
          <div className="p-4 bg-white shadow-inner md:p-6 rounded-3xl backdrop-blur-md bg-opacity-98">
            <div className="flex flex-col items-center gap-4 md:gap-6 md:flex-row">
              ...
              <div className="flex-1 text-center md:text-left">
                <h3
                  className="flex flex-col items-center gap-2 text-xl font-bold md:text-2xl md:flex-row md:justify-start md:gap-3"
                  style={{ color: '#00204f' }}
                >
                  <span>Njere ERP</span>
                  <motion.span
                    className="px-3 py-1 text-sm font-medium text-white rounded-full md:text-lg"
                    style={{ backgroundColor: '#04baab' }}
                ...
                <div className="flex flex-wrap justify-center gap-2 mt-3 md:justify-start md:gap-3 md:mt-4">
                  {[
                    ...
                    <motion.div
                      key={index}
                      className="flex items-center gap-1 px-2 py-1 text-xs font-medium rounded-full md:gap-2 md:px-3 md:py-2 md:text-sm"
                      style={{
              ...
              {/* Buttons */}
              <div className="flex flex-col flex-shrink-0 gap-3 sm:flex-row sm:gap-4">
                <motion.button
                  onClick={declineCookies}
                  className="px-6 py-2 text-sm font-semibold transition-all duration-300 border-2 cursor-pointer rounded-xl hover:shadow-lg md:px-8 md:py-3 md:text-base md:rounded-2xl"
                  style={{
                    color: '#00204f',
                    borderColor: '#00204f',
                ...
                <motion.button
                  ...
                  className="px-6 py-2 text-sm font-semibold text-white transition-all duration-300 shadow-xl cursor-pointer rounded-xl md:px-8 md:py-3 md:text-base md:rounded-2xl"
                  style={{ backgroundColor: '#04baab' }}
                  whileHover={{
                    backgroundColor: '#00204f',
                    scale: 1.02,
