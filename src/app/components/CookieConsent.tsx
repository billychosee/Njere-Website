  ...
  return (
    <AnimatePresence>
      {showBanner && (
        ...
        >
          {/* Icon */}
          <div className="flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-r from-[#0577DD] to-[#8DC440] text-white text-2xl shadow-lg">
            <FaCookieBite />
          </div>
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-white rounded-full bg-gradient-to-r from-[#0577DD] to-[#8DC440] shadow hover:opacity-90 transition"
            >
              Accept
            </button>
          </div>
