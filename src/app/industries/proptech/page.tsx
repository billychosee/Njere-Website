...
export const metadata: Metadata = {
  title: "PropTech Solutions for Zimbabwe & Africa | Smatech Group",
  ...
  openGraph: {
    ...
    url: "https://smatechgroup.com/industries/proptech",
    type: "website",
  },
};
...
export default function PropTech() {
  const structuredData = {
    ...
    "@type": "Organization",
    "name": "Smatech Group PropTech Solutions",
  ...
  return (
    <div className="pt-10 text-black bg-white md:pt-24">
      ...
      <CtaSection
        ...
        description="Partner with Smatech Group to implement cutting-edge PropTech solutions tailored for African real estate markets."
        primaryButton={{
