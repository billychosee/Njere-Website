...
export const metadata: Metadata = {
  title: "Insurtech Solutions | Smatech Group",
  ...
  openGraph: {
    ...
    url: "https://smatechgroup.com/industries/insuretech",
    type: "website",
  },
};
...
export default function Insuretech() {
  ...
  const faqItems = [
    {
      question: "How does Smatech's insurtech work for microinsurance?",
    ...
    {
      question: "What makes Smatech Group a trusted insurtech partner in Africa?",
  ...
  const ctaProps = {
    ...
    description: "Partner with Smatech to build smart, scalable, and future-ready insurtech systems.",
    primaryButton: {
  ...
  const whyPartnerSmatechProps = {
    heading: "Why Partner with Smatech for Insuretech?",
    paragraph: "At Smatech Group, we build next-generation Insuretech platforms tailored for Africa's unique challenges. We provide the tools, APIs, and support to help you transform your insurance business by focusing on key areas:",
    imageSrc: "/smatech_partnership_benefits.jpg",
    imageAlt: "Benefits of partnering with Smatech for Insuretech",
    listItems: [
  ...
  const whoWeServeProps = {
    ...
    paragraph: "Smatech Group's Insuretech solutions empower a diverse range of stakeholders across the insurance ecosystem, addressing their unique needs:",
  ...
  return (
    <div className="pt-10 text-black bg-white md:pt-24">
      ...
      {/* Smatech Group's Insuretech Capabilities */}
      ...
      {/* Why Partner with Smatech for Insuretech? - Replaced with ImageTextListSection */}
      <ImageTextListSection {...whyPartnerSmatechProps} />
